            ...
            <section>
                ...
                <div id="sec2">
                    ...
                    if($act=="add_operator")
                    {
                        ...
                        if($_POST['submit'])
                        {
                            mysql_query("INSERT INTO `operators` (`id`, `op_username`, `op_password`, `op_status`, `op_ipaddr`, `op_belongsto`) VALUES (NULL, '".$_POST['username']."', '".$_POST['password']."', '1', '".$_SERVER['REMOTE_ADDR']."', '".$_SESSION['adm_host']."');");
                            ?>
                        ...
                        else
                        {
                            ...
                            <form action="admin.php?action=add_operator" method="POST">
                                Username: <input type="text" name="username" value="" placeholder="op_<?php echo $_SESSION['adm_host']; ?>_username" /><br>
                    ...
                    if($act=="remove_operator")
                    {
                        ...
                        else
                        {
                            ...
                            <table border="none" width="100%">
                                ...
                                <?php
                                $query = mysql_query("SELECT * FROM operators WHERE `op_belongsto`='".$_SESSION['adm_host']."'");
                                while($row = mysql_fetch_assoc($query))
                                {
                                    ?>
                    ...
                    if($act=="")
                    {
                        $query = mysql_query("SELECT * FROM hosts WHERE `id`='".$_SESSION['adm_host']."'");
                        while($row = mysql_fetch_assoc($query))
                        {
                            ?>
                            <table border="none" width="100%">
                                ...
                                <tr>
                                    <td><?php echo $_SESSION['adm_host']; ?></td>
                                    <td><?php echo $row['hostname']; ?></td>
                                    <td><a style="color:black;" href="?action=add_operator"><button>Add Operators</button></a> <a style="color:black;" href="?action=remove_operator"><button>Remove Operator</button></a> <a style="color:black;" href="viewops.php"><button>View/edit Operators</button></a> <a style="color:black;" href="whos.php"><button>Whos chatting?</button></a> <a style="color:black;" href="cal.php"><button>Events</button></a> <a style="color:black;" href="canned.php"><button>Manage canned replies</button></a> <a style="color:black;" href="smod.php"><button>Super Mods</button></a></td>
                                </tr>
                            </table>
                            <?php
                        }
