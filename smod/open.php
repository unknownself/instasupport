							...
							<section>
								...
								<div id="sec2">
									<?php
										...
										$query = mysql_query("SELECT * FROM messages WHERE `chatid`='".$id."'");
										?>
										<div id="chat-wrap">
									<div id="chat-area">
										<?php
										while($row = mysql_fetch_assoc($query)) {
											echo '<b><font color="black">'.$row['name'].'</font></b><font color="black"> says: <br><font color="black">'.$row['message'].'<br></font>';
										}
										?></div>
								</div><?php
									?>
