        ...
        <div class="data-container">
            ...
            <section>
                ...
                <div id="sec2">
                    ...
                    echo 'Currently '.$count.' active chats.';
                    echo '<br>';
                    echo '<table border="1">';
                    echo '<tbody><tr><th scope="col">Operator</th><th scope="col">Info</th><th scope="col">Options</th></tr>';
                    while($row = mysql_fetch_assoc($query)) {
                        echo '<tr><td>'.$row['operator_handling'].'</td><td>In chat with: <b>'.$row['name'].'</b></td><td><a href="spy.php?operator='.$row['operator_handling'].'&customer='.$row['name'].'">Spy</a></td></tr>';
                    }
                    echo '</tbody>';
                    echo '</table>';
                    ?>
