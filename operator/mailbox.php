...
if(!isset($_SESSION['op_name'])) { exit('Security! Arrest this man!'); }
?>
<!DOCTYPE html>
...
<!--[if gt IE 9]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
	<head>
		...
		<script>var myName = '<?php echo $_SESSION['op_name']; ?>';</script>
		...
		<header class="navbar">
			...
			<div class="navbar-inner">
				...
				<div class="nav-collapse">
					...
					<nav>
						<ul role="navigation">
							<li><a href="../admin/"><span class="awe-leaf"></span>Admin</a></li>
							<li><a href="#my-reviews"><span class="awe-group"></span>My Reviews</a></li>
							<li><a href="#data-container"><span class="awe-picture"></span>System Notices</a></li>
							<li><a href="#my-settings"><span class="awe-wrench"></span>My Settings</a></li>
						</ul>
					</nav>
					<!-- /Header navigation -->
		...
		<div class="container-fluid">
			...
			<div class="sidebar">
				...
				<figure class="user-profile">
					...
					<figcaption>
						<a href="#"><?php echo $_SESSION['op_name']; ?></a>
						<em>operator</em>
						<ul class="user-profile-actions">
							<li><a href="mailbox.php" title="Open mailbox"><span class="awe-envelope-alt"></span></a></li>
				...
				<div class="row-fluid">
					...
					<article class="span12 data-block nested">
						...
						<div class="data-container">
							...
							<!-- Data block header -->
							<header>
								<h2>Messages from System Admin</h2>
							...
							<!-- Data block content -->
							<section>
								<p><font color="green">System is running fine without any issues</font></p>
								<div id="sec"></div>
							...
							<section>
								...
								<div id="sec2">
									...
									<?php error_reporting(0);
										$query = mysql_query("SELECT * FROM `mailbox` WHERE `to`='".$_SESSION['op_host']."'");
										while($row = mysql_fetch_assoc($query))
										{
											echo "<b>From: ".$row['from']."</b><br>";
											?>
												<b>Message</b>: 
		...
		<script>
			function opchecker() {
				...
				$.ajax({
					...
					data: { 'tryit': tryit, 'hid': '<?php echo $_SESSION['op_host']; ?>' },
			...
			function gooffline() {
				$.ajax({
					...
					data: { 'function': 'offline', 'hid': '<?php echo $_SESSION['op_host']; ?>' },
					success: function(data)
					{
			...
			function goonline() {
				$.ajax({
					type: "POST",
					url: "../inc/ajax_opfunc_status.php",
					data: { 'function': 'online', 'hid': '<?php echo $_SESSION['op_host']; ?>' },
					success: function(data)
					{
