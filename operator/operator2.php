...
$sectry = $_GET['securehash'];
if($sectry != $securehash) {
	exit('Security Alert - Security Hash Invalid');
}
mysql_query("INSERT INTO `logs` (`id`, `who`, `message`, `type`)  VALUES (NULL, '".$name."', '".$name." has entered chat ".$chatId.".', 'regular');");
?>
<!DOCTYPE html>
		...
		<div class="container-fluid">
			...
			<div class="sidebar">
				...
				<section class="sidebar-box sidebar-dark">
					...
					<p class="separator"></p>
					<a href="#" onClick="leavechat()" class="btn btn-mini btn-alt btn-primary">Leave chat</a><br>Transfer to:<br>
					<form>
						<select id='transfers'>
							<option>&nbsp;</option>
						<?php
